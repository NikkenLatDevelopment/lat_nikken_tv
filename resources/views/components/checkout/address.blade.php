...
<ul class="nav nav-pills mt-3 mb-1" role="tablist">
    <li class="nav-item" role="presentation" wire:click="changeTypeSelectedAddress(0)">
    ...
    @if ($this->addressForm->totalAddresses > 0)
        <li class="nav-item" role="presentation" wire:click="changeTypeSelectedAddress(1)">
...
<div class="tab-content">
    <div class="tab-pane fade show active" id="checkout-address-form" role="tabpanel" aria-labelledby="checkout-address-form-tab" tabindex="0" wire:ignore.self>
        <div class="pt-2"><x-checkout.address-country /></div>
    </div>
