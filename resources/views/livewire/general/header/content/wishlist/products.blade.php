    ...
    <div class="products">
                ...
                <a href="{{ route('product.show', [ 'brandSlug' => $product['brandSlug'], 'productSlug' => $product['slug'] ]) }}" class="text-decoration-none">
                    <div class="row gx-3 align-items-center">
                        ...
                        <div class="col text-truncate">
                            <div class="small d-flex align-items-center mb-1"><div class="lh-1 d-inline-block"><x-product.rating-star :ratingTotal="$product['rating']" /></div> <span class="small text-black-50 opacity-50 fw-bold ms-1 custom margin-bottom-1">({{ $product['rating'] }})</span></div>
        ...
        @empty
            <div class="text-center d-flex align-items-center justify-content-center empty">
                <div>
                    <img src="{{ asset('assets/img/general/empty-product.png') }}" srcset="{{ asset('assets/img/general/empty-product-2x.png') }} 2x" class="img-fluid" alt="Lista de Deseos">
