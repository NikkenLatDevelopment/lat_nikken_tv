<div>
    <div class="row align-items-center">
        <div class="col-12 col-sm-5 col-md-5">
            <a href="{{ route('product.show', [ 'brandSlug' => $product['brandSlug'], 'productSlug' => $product['slug'] ]) }}" class="text-decoration-none">
                <div class="row gx-3 d-flex align-items-center">
                    ...
                    <div class="col">
                        <div class="text-center text-md-start">
                            <div class="h6 text-dark fw-bold mb-0 mt-2 mt-md-0 mb-2">{{ $product['name'] }}</div>
        ...
        <div class="col col-md-1">
            <div class="text-center text-md-start">
                <button class="btn btn-link link-primary opacity-50 text-decoration-none d-flex align-items-center mx-auto mt-1 pt-2 mt-md-0 pt-md-0" wire:click="$dispatch('checkout.index.content.main.removeProduct', { productId: {{ $product['id'] }} })"><i class="fi fi-br-trash"></i> <span class="small d-sm-none ms-1">Eliminar</span></button>
            </div>
        </div>
    </div>
</div>
